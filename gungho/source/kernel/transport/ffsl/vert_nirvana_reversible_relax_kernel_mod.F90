...
!> @brief Computes the fractional vertical mass flux using the monotonic reversible Nirvana reconstruction.
...
!!          values at cell edges. A relaxed limiter is applied to ensure monotonicity.
...
module vert_nirvana_reversible_relax_kernel_mod
...
type, public, extends(kernel_type) :: vert_nirvana_reversible_relax_kernel_type
  private
...
contains
  procedure, nopass :: vert_nirvana_reversible_relax_code
end type

!-------------------------------------------------------------------------------
! Contained functions/subroutines
!-------------------------------------------------------------------------------
public :: vert_nirvana_reversible_relax_code

contains

!> @brief Compute the flux using the relaxed monotonic reversible Nirvana reconstruction.
...
subroutine vert_nirvana_reversible_relax_code( nlayers,   &
                                               flux_high, &
                                               frac_wind, &
                                               dep_pts,   &
                                               field,     &
...
end subroutine vert_nirvana_reversible_relax_code

end module vert_nirvana_reversible_relax_kernel_mod
