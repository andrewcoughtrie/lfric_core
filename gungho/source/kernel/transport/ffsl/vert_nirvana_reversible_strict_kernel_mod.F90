...
!!          values at cell edges. A limiter is applied to ensure monotonicity.
...
module vert_nirvana_reversible_strict_kernel_mod
...
type, public, extends(kernel_type) :: vert_nirvana_reversible_strict_kernel_type
  private
...
contains
  procedure, nopass :: vert_nirvana_reversible_strict_code
end type

!-------------------------------------------------------------------------------
! Contained functions/subroutines
!-------------------------------------------------------------------------------
public :: vert_nirvana_reversible_strict_code
...
subroutine vert_nirvana_reversible_strict_code( nlayers,   &
                                                flux_high, &
                                                frac_wind, &
                                                dep_pts,   &
                                                field,     &
...
end subroutine vert_nirvana_reversible_strict_code

end module vert_nirvana_reversible_strict_kernel_mod
