...
!> @brief Computes the fractional vertical mass flux using the PPM reconstruction.
...
subroutine vert_ppm_no_limiter_code( nlayers,   &
  ...
  ! field_local and dz_local have index: | 1 | 2 | 3 | 4 | for fourth_order_vertical_edge
  ...
  edge_to_do = 0_i_def
  call fourth_order_vertical_edge( field_local, dz_local, edge_to_do, edge_below(k) )
  edge_to_do = 1_i_def
  call fourth_order_vertical_edge( field_local, dz_local, edge_to_do, edge_below(k+1) )
